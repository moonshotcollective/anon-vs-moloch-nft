...
function ComingSoon({ goToNextStep }) {
  const countdownRenderer = ({ days, hours, minutes, seconds, completed }) => {
    ...
    return (
      <>
        <div class="text-center font-spacemono container mx-auto">
        ...
        <div class="w-3/4 mx-auto text-center mt-20">
          <a href=" https://www.addevent.com/event/Qu10410679" class="leading-relaxed text-lg mt-20 text-3xl font-bold text-green-header font-spacemono underline">
  ...
  return (
    <div className="grid grid-cols-1">
      <div className="flex flex-wrap font-spacemono">
        ...
        <div className="flex flex-wrap w-1/3 p-20 sm:p-6 mr-16">
          <div className="max-w-full flex flex-col">
            ...
            <br/>
            <p className="mt-16 text-5xl font-normal text-purple-final font-spacemono font-bold">
